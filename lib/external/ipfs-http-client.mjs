(() => {
  ...
  var require_err_code = __commonJS({
    "node_modules/@multiformats/multiaddr/node_modules/err-code/index.js"(exports2, module2) {
      "use strict";
  ...
  var require_common = __commonJS({
    "node_modules/@libp2p/logger/node_modules/debug/src/common.js"(exports2, module2) {
      function setup(env) {
  ...
  var require_browser = __commonJS({
    "node_modules/@libp2p/logger/node_modules/debug/src/browser.js"(exports2, module2) {
  ...
  var require_err_code2 = __commonJS({
    "node_modules/ipfs-http-client/node_modules/err-code/index.js"(exports2, module2) {
      "use strict";
      function assign(obj, props) {
        for (const key in props) {
          Object.defineProperty(obj, key, {
  ...
  var require_err_code3 = __commonJS({
    "node_modules/@libp2p/peer-id/node_modules/err-code/index.js"(exports2, module2) {
      "use strict";
      function assign(obj, props) {
        for (const key in props) {
          Object.defineProperty(obj, key, {
  ...
  var require_err_code4 = __commonJS({
    "node_modules/ipfs-core-utils/node_modules/err-code/index.js"(exports2, module2) {
      "use strict";
      function assign(obj, props) {
        for (const key in props) {
          Object.defineProperty(obj, key, {
  ...
  var require_err_code5 = __commonJS({
    "node_modules/ipfs-unixfs/node_modules/err-code/index.js"(exports2, module2) {
      "use strict";
      function assign(obj, props) {
        for (const key in props) {
          Object.defineProperty(obj, key, {
  ...
  var LOAD_BASE = (name8) => Promise.reject(new Error(`No base found for "${name8}"`));
  ...
  var from = ({ name: name8, prefix, encode: encode15, decode: decode16 }) => new Codec(name8, prefix, encode15, decode16);
  var baseX = ({ prefix, name: name8, alphabet: alphabet2 }) => {
    const { encode: encode15, decode: decode16 } = base_x_default(alphabet2, name8);
    return from({
      prefix,
      name: name8,
      encode: encode15,
  ...
  var from2 = ({ name: name8, code: code8, encode: encode15 }) => new Hasher(name8, code8, encode15);
  var Hasher = class {
  ...
  var createReplace = configure((api) => {
    const replace = async (config, options = {}) => {
      ...
      const res = await api.post("config/replace", {
        signal,
        searchParams: toUrlSearchParams(options),
        ...await multipartRequest([fromString3(JSON.stringify(config))], controller, options.headers)
      });
      await res.text();
    };
    return replace;
  ...
  var encodeAddParams = ({ cid, service, background, name: name8, origins }) => {
  ...
  function toCoreInterface5({ name: name8, hash, size, mode, mtime, mtimeNsecs }) {
    const output = {
      path: name8,
      cid: CID.parse(hash),
      size: parseInt(size)
