...
const filename = ".tmp/standards.sqlite";
const sqlFilename = ".tmp/standards.sql";
...
let callCount = 0;
export const generateDatabase = (jsonSchema, typeJSON, folderLength) => {
