...
export class OMM {
    ...
    static add_CCSDS_OMM_VERS(builder, CCSDS_OMM_VERS) {
    ...
    static add_MEAN_ELEMENT_THEORY(builder, MEAN_ELEMENT_THEORY) {
    ...
    static add_EPHEMERIS_TYPE(builder, EPHEMERIS_TYPE) {
        builder.addFieldInt8(25, EPHEMERIS_TYPE, ephemerisType.SGP4);
    }
    static add_CLASSIFICATION_TYPE(builder, CLASSIFICATION_TYPEOffset) {
    ...
    static add_USER_DEFINED_MICROSECONDS(builder, USER_DEFINED_MICROSECONDS) {
