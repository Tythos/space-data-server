...
export class maneuverParameters {
    ...
    static add_MAN_EPOCH_IGNITION(builder, MAN_EPOCH_IGNITIONOffset) {
        builder.addFieldOffset(0, MAN_EPOCH_IGNITIONOffset, 0);
    }
    static add_MAN_DURATION(builder, MAN_DURATION) {
        builder.addFieldFloat64(1, MAN_DURATION, 0.0);
    }
    static add_MAN_DELTA_MASS(builder, MAN_DELTA_MASS) {
        builder.addFieldFloat64(2, MAN_DELTA_MASS, 0.0);
    }
    static add_MAN_REF_FRAME(builder, MAN_REF_FRAME) {
        builder.addFieldInt8(3, MAN_REF_FRAME, manCovRefFrame.RSW);
    }
    static add_MAN_DV_1(builder, MAN_DV_1) {
        builder.addFieldFloat64(4, MAN_DV_1, 0.0);
    }
    static add_MAN_DV_2(builder, MAN_DV_2) {
        builder.addFieldFloat64(5, MAN_DV_2, 0.0);
    }
    static add_MAN_DV_3(builder, MAN_DV_3) {
