...
export class CDM {
    ...
    static add_CCSDS_CDM_VERS(builder, CCSDS_CDM_VERS) {
    ...
    static add_MESSAGE_FOR(builder, MESSAGE_FOROffset) {
        builder.addFieldOffset(3, MESSAGE_FOROffset, 0);
    }
    static add_MESSAGE_ID(builder, MESSAGE_IDOffset) {
        builder.addFieldOffset(4, MESSAGE_IDOffset, 0);
    }
    static add_TCA(builder, TCAOffset) {
        builder.addFieldOffset(5, TCAOffset, 0);
    }
    static add_MISS_DISTANCE(builder, MISS_DISTANCE) {
        builder.addFieldFloat64(6, MISS_DISTANCE, 0.0);
    }
    static add_RELATIVE_SPEED(builder, RELATIVE_SPEED) {
        builder.addFieldFloat64(7, RELATIVE_SPEED, 0.0);
    }
    static add_RELATIVE_POSITION_R(builder, RELATIVE_POSITION_R) {
        builder.addFieldFloat64(8, RELATIVE_POSITION_R, 0.0);
    }
    static add_RELATIVE_POSITION_T(builder, RELATIVE_POSITION_T) {
        builder.addFieldFloat64(9, RELATIVE_POSITION_T, 0.0);
    }
    static add_RELATIVE_POSITION_N(builder, RELATIVE_POSITION_N) {
        builder.addFieldFloat64(10, RELATIVE_POSITION_N, 0.0);
    }
    static add_RELATIVE_VELOCITY_R(builder, RELATIVE_VELOCITY_R) {
        builder.addFieldFloat64(11, RELATIVE_VELOCITY_R, 0.0);
    }
    static add_RELATIVE_VELOCITY_T(builder, RELATIVE_VELOCITY_T) {
        builder.addFieldFloat64(12, RELATIVE_VELOCITY_T, 0.0);
    }
    static add_RELATIVE_VELOCITY_N(builder, RELATIVE_VELOCITY_N) {
        builder.addFieldFloat64(13, RELATIVE_VELOCITY_N, 0.0);
    }
    static add_START_SCREEN_PERIOD(builder, START_SCREEN_PERIODOffset) {
        builder.addFieldOffset(14, START_SCREEN_PERIODOffset, 0);
    }
    static add_STOP_SCREEN_PERIOD(builder, STOP_SCREEN_PERIODOffset) {
        builder.addFieldOffset(15, STOP_SCREEN_PERIODOffset, 0);
    }
    static add_SCREEN_VOLUME_FRAME(builder, SCREEN_VOLUME_FRAME) {
        builder.addFieldInt8(16, SCREEN_VOLUME_FRAME, objectCenteredReferenceFrame.RTN);
    }
    static add_SCREEN_VOLUME_SHAPE(builder, SCREEN_VOLUME_SHAPE) {
        builder.addFieldInt8(17, SCREEN_VOLUME_SHAPE, screeningVolumeShape.ELLIPSOID);
    }
    static add_SCREEN_VOLUME_X(builder, SCREEN_VOLUME_X) {
        builder.addFieldFloat64(18, SCREEN_VOLUME_X, 0.0);
    }
    static add_SCREEN_VOLUME_Y(builder, SCREEN_VOLUME_Y) {
        builder.addFieldFloat64(19, SCREEN_VOLUME_Y, 0.0);
    }
    static add_SCREEN_VOLUME_Z(builder, SCREEN_VOLUME_Z) {
        builder.addFieldFloat64(20, SCREEN_VOLUME_Z, 0.0);
    }
    static add_SCREEN_ENTRY_TIME(builder, SCREEN_ENTRY_TIMEOffset) {
        builder.addFieldOffset(21, SCREEN_ENTRY_TIMEOffset, 0);
    }
    static add_SCREEN_EXIT_TIME(builder, SCREEN_EXIT_TIMEOffset) {
        builder.addFieldOffset(22, SCREEN_EXIT_TIMEOffset, 0);
    }
    static add_COLLISION_PROBABILITY(builder, COLLISION_PROBABILITY) {
        builder.addFieldFloat64(23, COLLISION_PROBABILITY, 0.0);
    }
    static add_COLLISION_PROBABILITY_METHOD(builder, COLLISION_PROBABILITY_METHODOffset) {
        builder.addFieldOffset(24, COLLISION_PROBABILITY_METHODOffset, 0);
    }
    static add_OBJECT1(builder, OBJECT1Offset) {
        builder.addFieldOffset(25, OBJECT1Offset, 0);
    }
    static add_OBJECT2(builder, OBJECT2Offset) {
