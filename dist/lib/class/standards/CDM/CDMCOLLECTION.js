...
export class CDMCOLLECTION {
    ...
    static createCDMCOLLECTION(builder, RECORDSOffset) {
        ...
        CDMCOLLECTION.add_RECORDS(builder, RECORDSOffset);
        return CDMCOLLECTION.endCDMCOLLECTION(builder);
    }
    unpack() {
        return new CDMCOLLECTIONT(this.bb.createObjList(this.RECORDS.bind(this), this.RECORDS_Length()));
    }
    unpackTo(_o) {
...
export class CDMCOLLECTIONT {
    ...
    pack(builder) {
        const RECORDS = CDMCOLLECTION.create_RECORDS_Vector(builder, builder.createObjectOffsetList(this.RECORDS));
