...
export class CDMObject {
    ...
    static add_OBJECT(builder, OBJECT) {
        builder.addFieldInt8(1, OBJECT, objectNumber.OBJECT1);
    }
    static add_OBJECT_DESIGNATOR(builder, OBJECT_DESIGNATOROffset) {
        builder.addFieldOffset(2, OBJECT_DESIGNATOROffset, 0);
    }
    static add_CATALOG_NAME(builder, CATALOG_NAMEOffset) {
    ...
    static add_INTERNATIONAL_DESIGNATOR(builder, INTERNATIONAL_DESIGNATOROffset) {
    ...
    static add_OPERATOR_CONTACT_POSITION(builder, OPERATOR_CONTACT_POSITIONOffset) {
        builder.addFieldOffset(7, OPERATOR_CONTACT_POSITIONOffset, 0);
    }
    static add_OPERATOR_ORGANIZATION(builder, OPERATOR_ORGANIZATIONOffset) {
        builder.addFieldOffset(8, OPERATOR_ORGANIZATIONOffset, 0);
    }
    static add_EPHEMERIS_NAME(builder, EPHEMERIS_NAMEOffset) {
        builder.addFieldOffset(9, EPHEMERIS_NAMEOffset, 0);
    }
    static add_COVARIANCE_METHOD(builder, COVARIANCE_METHOD) {
    ...
    static add_GRAVITY_MODEL(builder, GRAVITY_MODELOffset) {
        builder.addFieldOffset(14, GRAVITY_MODELOffset, 0);
    }
    static add_ATMOSPHERIC_MODEL(builder, ATMOSPHERIC_MODELOffset) {
        builder.addFieldOffset(15, ATMOSPHERIC_MODELOffset, 0);
    }
    static add_N_BODY_PERTURBATIONS(builder, N_BODY_PERTURBATIONSOffset) {
        builder.addFieldOffset(16, N_BODY_PERTURBATIONSOffset, 0);
    }
    static add_SOLAR_RAD_PRESSURE(builder, SOLAR_RAD_PRESSURE) {
        builder.addFieldInt8(17, +SOLAR_RAD_PRESSURE, +false);
    }
    static add_EARTH_TIDES(builder, EARTH_TIDES) {
        builder.addFieldInt8(18, +EARTH_TIDES, +false);
    }
    static add_INTRACK_THRUST(builder, INTRACK_THRUST) {
        builder.addFieldInt8(19, +INTRACK_THRUST, +false);
    }
    static add_TIME_LASTOB_START(builder, TIME_LASTOB_STARTOffset) {
        builder.addFieldOffset(20, TIME_LASTOB_STARTOffset, 0);
    }
    static add_TIME_LASTOB_END(builder, TIME_LASTOB_ENDOffset) {
        builder.addFieldOffset(21, TIME_LASTOB_ENDOffset, 0);
    }
    static add_RECOMMENDED_OD_SPAN(builder, RECOMMENDED_OD_SPAN) {
        builder.addFieldFloat64(22, RECOMMENDED_OD_SPAN, 0.0);
    }
    static add_ACTUAL_OD_SPAN(builder, ACTUAL_OD_SPAN) {
        builder.addFieldFloat64(23, ACTUAL_OD_SPAN, 0.0);
    }
    static add_OBS_AVAILABLE(builder, OBS_AVAILABLE) {
        builder.addFieldInt32(24, OBS_AVAILABLE, 0);
    }
    static add_OBS_USED(builder, OBS_USED) {
        builder.addFieldInt32(25, OBS_USED, 0);
    }
    static add_TRACKS_AVAILABLE(builder, TRACKS_AVAILABLE) {
        builder.addFieldInt32(26, TRACKS_AVAILABLE, 0);
    }
    static add_TRACKS_USED(builder, TRACKS_USED) {
        builder.addFieldInt32(27, TRACKS_USED, 0);
    }
    static add_RESIDUALS_ACCEPTED(builder, RESIDUALS_ACCEPTED) {
        builder.addFieldFloat64(28, RESIDUALS_ACCEPTED, 0.0);
    }
    static add_WEIGHTED_RMS(builder, WEIGHTED_RMS) {
        builder.addFieldFloat64(29, WEIGHTED_RMS, 0.0);
    }
    static add_AREA_PC(builder, AREA_PC) {
        builder.addFieldFloat64(30, AREA_PC, 0.0);
    }
    static add_AREA_DRG(builder, AREA_DRG) {
        builder.addFieldFloat64(31, AREA_DRG, 0.0);
    }
    static add_AREA_SRP(builder, AREA_SRP) {
        builder.addFieldFloat64(32, AREA_SRP, 0.0);
    }
    static add_MASS(builder, MASS) {
        builder.addFieldFloat64(33, MASS, 0.0);
    }
    static add_CR_AREA_OVER_MASS(builder, CR_AREA_OVER_MASS) {
        builder.addFieldFloat64(34, CR_AREA_OVER_MASS, 0.0);
    }
    static add_THRUST_ACCELERATION(builder, THRUST_ACCELERATION) {
        builder.addFieldFloat64(35, THRUST_ACCELERATION, 0.0);
    }
    static add_SEDR(builder, SEDR) {
