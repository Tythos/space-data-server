...
var argv = yargs_default(process.argv.slice(2)).usage("Usage: $0 [options] <name>").demandCommand(1).option("u", {
  alias: "uppercase",
  describe: "Convert name to uppercase",
  type: "boolean"
}).help().argv;
var name = argv._[0];
var greeting = `Hello, ${argv.uppercase ? name.toUpperCase() : name}!`;
